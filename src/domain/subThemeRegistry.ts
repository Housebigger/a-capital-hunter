...
const subThemeConfig = [
  ...
  { id: "optical-interconnect", name: "光互连", shortName: "光互连", themeId: "ai-computing", displayOrder: 4, primarySectorId: "optical-modules", areaWeight: 0.85 },
  { id: "liquid-cooling-infra", name: "液冷基础设施", shortName: "液冷基建", themeId: "ai-computing", displayOrder: 5, primarySectorId: "liquid-cooled-servers", areaWeight: 0.65 },
  // 机器人/物理AI (3)
  ...
  { id: "motion-control", name: "运动控制", shortName: "运动控制", themeId: "robotics-physical-ai", displayOrder: 4, primarySectorId: "servo-systems", areaWeight: 0.60 },
  // 低空经济 (2)
  ...
  { id: "drone-systems", name: "无人机系统", shortName: "无人机", themeId: "low-altitude-economy", displayOrder: 3, primarySectorId: "drones", areaWeight: 0.65 },
  { id: "low-alt-comm", name: "低空通信导航", shortName: "低空通导", themeId: "low-altitude-economy", displayOrder: 4, primarySectorId: "low-altitude-communication", areaWeight: 0.50 },
  // 半导体 (3)
  ...
  { id: "materials-process", name: "材料工艺", shortName: "材料工艺", themeId: "semiconductors", displayOrder: 4, primarySectorId: "photoresist", areaWeight: 0.55 },
  { id: "chip-arch", name: "芯片架构", shortName: "芯片架构", themeId: "semiconductors", displayOrder: 5, primarySectorId: "chiplet", areaWeight: 0.70 },
  // 新能源 (3)
  ...
  { id: "battery-tech", name: "电池技术", shortName: "电池技术", themeId: "new-energy", displayOrder: 4, primarySectorId: "power-batteries", areaWeight: 0.70 },
  // 军工/商业航天 (3)
  ...
  { id: "defense-informatics-st", name: "军工信息化", shortName: "军工信息化", themeId: "defense-aerospace", displayOrder: 4, primarySectorId: "defense-informatics", areaWeight: 0.50 },
  // 创新药/医药 (3)
  ...
  { id: "electric-drive", name: "电驱动", shortName: "电驱动", themeId: "new-energy-vehicles", displayOrder: 4, primarySectorId: "electric-drive-systems", areaWeight: 0.70 },
  { id: "smart-cockpit-st", name: "智能座舱", shortName: "智能座舱", themeId: "new-energy-vehicles", displayOrder: 5, primarySectorId: "smart-cockpit", areaWeight: 0.65 },
  // 消费电子/VR (2)
  ...
  { id: "vr-ar", name: "VR/AR", shortName: "VR/AR", themeId: "consumer-electronics", displayOrder: 3, primarySectorId: "vr-ar-devices", areaWeight: 0.60 },
  { id: "optical-acoustic", name: "光学声学", shortName: "光声学", themeId: "consumer-electronics", displayOrder: 4, primarySectorId: "optical-lenses", areaWeight: 0.50 },
  // 数字经济/数据要素 (3)
  ...
  { id: "security-software", name: "安全软件", shortName: "安全软件", themeId: "digital-economy", displayOrder: 4, primarySectorId: "data-security", areaWeight: 0.55 },
  // 金融科技 (2)
  ...
  { id: "digital-finance", name: "数字金融", shortName: "数字金融", themeId: "fintech", displayOrder: 3, primarySectorId: "digital-currency", areaWeight: 0.55 }
